...
public:
     ...
     * values from tasks.
     */
    void submit(task::Task task) noexcept override;
     ...
     * Synchronization primitives such as wait groups should be used to block 
     * the thread pool thread until all tasks are executed.
     */
    void stop();
...
private:
    ...
    UnboundedBlockingMPMCQueue<task::Task> queue_;
